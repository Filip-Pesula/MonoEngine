...
TextureRes::TextureRes(const std::string texturePath, TextureType textureType)
{
	/*
...
TextureRes::TextureRes(int width, int height, TextureType) {
...
void TextureRes::BindTo(int textureSlot)
{
	glActiveTexture(GL_TEXTURE0 + textureSlot);
	glBindTexture(GL_TEXTURE_2D, mTextureID);
}
uint32_t TextureRes::getTextureID()
{
	return mTextureID;
}
TextureRes::~TextureRes()
