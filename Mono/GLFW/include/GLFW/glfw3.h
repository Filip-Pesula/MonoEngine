 ...
 *
 *  @param[in] window The window that received the event.
 *  @param[in] size The number of dropped files.
 ...
 *
 *  @param[out] size Where to store the number of monitors in the returned
 ...
 *
 *  @param[in] monitor The monitor to query.
 *  @param[out] size Where to store the number of video modes in the returned
 *  array.  This is set to zero if an error occurred.
 ...
 *  @param[in] size The number of images in the specified array, or zero to
 ...
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 *  @param[out] size Where to store the number of axis values in the returned
 ...
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 *  @param[out] size Where to store the number of button states in the returned
 *  array.  This is set to zero if the joystick is not present or an error
 *  occurred.
 ...
 *
 *  This function sets the value of the GLFW timer.  It then continues to size
 ...
 *
 *  @param[out] size Where to store the number of extensions in the returned
 *  array.  This is set to zero if an error occurred.
